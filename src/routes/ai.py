...
async def ai_search(
    ...
    try:
        result = await list_properties(
            ...
            # Buyer-lens filters (compiled by nl_search, validated there).
            year_built_min=f.get("year_built_min"),
            year_built_max=f.get("year_built_max"),
            sqft_min=f.get("sqft_min"),
            lot_sqft_min=f.get("lot_sqft_min"),
            property_type=f.get("property_type"),
            school_district=f.get("school_district"),
